...
class TransformerDecoderLayer(Module):
    ...
    def forward(
        ...
        if self.norm_first:
            ...
            mha_x, attn_weights = self._mha_block(
                self.norm2(x), memory, memory_mask, memory_key_padding_mask, memory_is_causal, need_attn_weight
            )
            x = x + mha_x
            ...
            mha_x, attn_weights = self._mha_block(
                x, memory, memory_mask, memory_key_padding_mask, memory_is_causal, need_attn_weight
            )
